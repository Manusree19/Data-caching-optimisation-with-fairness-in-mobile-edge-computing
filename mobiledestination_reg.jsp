...
<head>
<title>Data Caching Optimization With Fairness in Mobile Edge Computing  s</title>
...
<div id="header">
    <br>
  <div class="shell">
    <h1>Data Caching Optimization With Fairness in Mobile Edge Computing  s</h1>
    <div class="search">
...
<div id="main">
  <div class="shell">
    ...
    <form name="myform" autocomplete="off" action="mobiledestination_regact.jsp" method="post" enctype="multipart/form-data" onsubmit="return validateform()">
